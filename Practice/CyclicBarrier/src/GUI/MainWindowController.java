...
public class MainWindowController implements Initializable {
    @FXML
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> indexBarrierColumn;
    @FXML
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> valuesBarrierColumn;
    @FXML
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> listValuesBarrierColumn;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        indexBarrierColumn.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getKey() + " "));
        valuesBarrierColumn.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getValue().getKey() + " "));
        listValuesBarrierColumn.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getValue().getValue() + " "));
    ...
    private void updateInterface(ProgramState currentProgState){
        ...
        try {
            ...
            populateBarrierTable(currentProgState);
        } catch (MyException e) {
    ...
    private void populateBarrierTable(ProgramState givenProgramState) {
        barrierTable.setItems(FXCollections.observableArrayList(new ArrayList<>(givenProgramState.getBarrierTable().getBarrierTable().entrySet())));
