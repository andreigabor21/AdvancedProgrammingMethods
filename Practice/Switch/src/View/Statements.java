...
public class Statements {
    ...
    private static IStatement ex11 = buildCompound(
            new VariableDeclarationStatement("a", new IntType()),
            new VariableDeclarationStatement("b", new IntType()),
            ...
            new SwitchStatement(new ArithmeticExpression('*',
                    ...
                    new ValueExpression(new IntValue(10)),
                        buildCompound(new PrintStatement(new VariableExpression("a")), new PrintStatement(new VariableExpression("b"))),
                        buildCompound(new PrintStatement(new ValueExpression(new IntValue(100))), new PrintStatement(new ValueExpression(new IntValue(200)))),
