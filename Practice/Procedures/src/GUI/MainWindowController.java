...
public class MainWindowController implements Initializable {
    ...
    @FXML
    public TableView<Map.Entry<String, Pair<List<String>, IStatement>>> procTable;
    @FXML
    public TableColumn<Map.Entry<String, Pair<List<String>, IStatement>>, String> procedureTableColumn;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        procedureTableColumn.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getValue() + " "));
        procedureBodyColumn.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getValue() + " "));
    ...
    private void updateInterface(ProgramState currentProgState){
        ...
        try {
            ...
            populateProcTableView(currentProgState);
        } catch (MyException e) {
    ...
    private void populateProcTableView(ProgramState givenProgramState){
        procTable.setItems(FXCollections.observableList(new ArrayList<>(givenProgramState.getProcTable().getContent().entrySet()))); //getHeap().getContent().entrySet())));
        heapTableView.refresh();
    }
