...
public class Statements {
    ...
    public static Pair<List<String>, IStatement> getSumPair() {
        ArrayList<String> TwoSumVarList = new ArrayList<>();
        TwoSumVarList.add("a");
        TwoSumVarList.add("b");
        IStatement TwoSumStmt = Statements.buildCompound(
                new VariableDeclarationStatement("v", new IntType()),
        ...
        return new Pair<>(TwoSumVarList, TwoSumStmt);
    }

    public static Pair<List<String>, IStatement> getProdPair() {
        ArrayList<String> TwoProdVarList = new ArrayList<>();
        TwoProdVarList.add("a");
        TwoProdVarList.add("b");
        IStatement TwoProdStmt = buildCompound(
                new VariableDeclarationStatement("v", new IntType()),
        ...
        return new Pair<>(TwoProdVarList, TwoProdStmt);
    }

    private static IStatement proc() {
        IStatement main = buildCompound(
                new VariableDeclarationStatement("v", new IntType()),
                ...
                new PrintStatement(new VariableExpression("v")),
                new ForkStatement(buildCompound(
                        new CallProcStatement("prod", Arrays.asList(
                                new VariableExpression("v"),
                                new VariableExpression("w"))
                        ),
                        new ForkStatement(
