...
public class ProgramState {
    ...
    public ProgramState(IStack<IStatement> executionStack, IDictionary<String, Value> symbolTable, IHeap<Value> heap, IList<Value> output, IDictionary<String,BufferedReader> fileTable, ILockTable lockTable, IStatement originalProgram) {
