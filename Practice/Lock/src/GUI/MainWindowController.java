...
public class MainWindowController implements Initializable {
    ...
    @FXML
    public TableColumn<Map.Entry<Integer,Integer>,Integer> valueColumn;
    @FXML
    ...
    private void updateInterface(ProgramState currentProgState){
        ...
        try {
            ...
            populateLockTable(currentProgState);
        } catch (MyException e) {
    ...
    private void populateLockTable(ProgramState givenProgramState) {
        lockTable.setItems(FXCollections.observableArrayList(givenProgramState.getLockTable().getContent().entrySet()));
        heapTableView.refresh();
    }
