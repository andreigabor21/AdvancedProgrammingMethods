...
public class MainWindowController implements Initializable {
    ...
    @FXML
    public TableColumn<Map.Entry<Integer,Integer>,Integer> locationColumn;
    @FXML
    public TableColumn<Map.Entry<Integer,Value>,Integer> valueColumn;
    ...
    private void populateLatchTableView(ProgramState givenProgramState){
        latchTableView.setItems(FXCollections.observableList(new ArrayList<>(givenProgramState.getLatchTable().getContent().entrySet())));
        heapTableView.refresh();
    }
