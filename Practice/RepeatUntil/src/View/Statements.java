...
public class Statements {
    ...
    private static IStatement repeatUntilStatement = buildCompound(
            new VariableDeclarationStatement("v", new IntType()),
    ...
    private static IStatement repeatUntilStatementTypecheckError = buildCompound(
            new VariableDeclarationStatement("v", new IntType()),
            new VariableDeclarationStatement("x", new IntType()),
            new VariableDeclarationStatement("y", new IntType()),
            new AssignmentStatement("v", new ValueExpression(new IntValue(0))),
    ...
    public static List<IStatement> getHardcodedStatements(){
        ...
        list.add(repeatUntilStatement);
        list.add(repeatUntilStatementTypecheckError);
