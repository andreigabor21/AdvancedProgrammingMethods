...
public class Statements {
    ...
    private static final IStatement for2020 = buildCompound(
            new VariableDeclarationStatement("a", new ReferenceType(new IntType())),
            ...
            new ForStatement("v",
                    ...
                    new ForkStatement(buildCompound(
                                            ...
                                            new AssignmentStatement("v",
                                                    new ArithmeticExpression('*',
                                                    new VariableExpression("v"), new HeapReadExpression(new VariableExpression("a"))))
                    ))
            ),
            new PrintStatement(new HeapReadExpression(new VariableExpression("a")))
    );

    private static final IStatement for2016 = buildCompound(
            new VariableDeclarationStatement("v", new IntType()),
