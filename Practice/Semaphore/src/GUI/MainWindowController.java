...
public class MainWindowController implements Initializable {
    ...
    @FXML
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> indexSemaphoreColumn;
    @FXML
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> valueSemaphoreColumn;
    @FXML
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> listValuesSemaphoreColumn;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        indexSemaphoreColumn.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getKey() + " "));
        valueSemaphoreColumn.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getValue().getKey() + " "));
        listValuesSemaphoreColumn.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getValue().getValue() + " "));
    ...
    private void updateInterface(ProgramState currentProgState){
        ...
        try {
            ...
            populateSemaphoreTable(currentProgState);
        } catch (MyException e) {
    ...
    private void populateSemaphoreTable(ProgramState givenProgramState) {
        semaphoreTable.setItems(FXCollections.observableArrayList(new ArrayList<>(givenProgramState.getSemaphoreTable().getSemaphoreTable().entrySet())));
